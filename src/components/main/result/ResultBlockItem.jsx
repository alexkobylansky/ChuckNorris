...
export default function ResultBlockItem(props) {
  ...
  return (
    <article className="result-block-item">
      <span className="icon-heart-block">
      ...
      <div className="result-block-item_container">
        ...
        <div className="result-block-item_wrapper">
          <p className="result-block_id"><span>ID: </span><a href="localhost:3000" className="result-block_id_href">XNaAxUduSw6zANDaIEab7A</a>
          </p>
          <div className="result-block_description">
            ...
            <div className="footer">
              <span>last update: 1923 hours update</span>
              <div className="tags">
                <span className="tag"><a href="localhost:3000">Celebrity</a></span>
              </div>
            </div>
          </div>
        </div>
